...
function CollectAndShare(i)
{
    ...
    var collectIcon = classNameContains("ImageView").depth(2).drawingOrder(9).findOnce(0);//右下角收藏按钮(2.1版本的depth为10)
    collectIcon.click();//点击收藏
    delay(2);
    var shareIcon = classNameContains("ImageView").depth(2).drawingOrder(10).findOnce(0);//右下角分享按钮
